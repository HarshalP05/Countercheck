  ...
  return (
    <>
      ...
      <div className='walk-body'>
        <div className="chead">
          <h3>A Quick guide to Visit our Website</h3>
        </div>
        <div className="wcard-container">
            ...
            <div className="content">
              ...
              <div className="walk-back">
                <div className="back-content">
                  <p><span className="click-text"></span> to see STEP 1</p>
                </div>
              </div>
            </div>
          </div>
          <div className="wcard" id="c2">
            <div className="content">
              ...
              <div className="walk-back">
                <div className="back-content">
                  <p><span className="click-text"></span> to see STEP 2</p>
                </div>
              </div>
            </div>
          </div>
          <div className="wcard" id="c3">
            <div className="content">
              ...
              <div className="walk-back">
                <div className="back-content">
                  <p><span className="click-text"></span> to see STEP 3</p>
                </div>
              </div>
            </div>
          </div>
          <div className="wcard" id="c4">
            <div className="content">
              ...
              <div className="walk-back">
                <div className="back-content">
                  <p><span className="click-text"></span> to see STEP 4</p>
                </div>
              </div>
            </div>
          </div>
